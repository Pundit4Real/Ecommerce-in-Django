...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('price', models.DecimalField(decimal_places=2, default='', max_digits=9999999999)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.DecimalField(decimal_places=2, default='', max_digits=9999999999)),
                ('total', models.DecimalField(decimal_places=2, default='', max_digits=9999999999)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(default='Fresh items', max_length=100)),
                ...
                ('price', models.DecimalField(decimal_places=2, default='', max_digits=9999999999)),
                ('old_price', models.DecimalField(decimal_places=2, default='', max_digits=999999999)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, default="I'm an amazing vendor", null=True)),
                ('address', models.CharField(default='123 Main Street.', max_length=100)),
                ('contact', models.CharField(default='+233 (598) 193277', max_length=100)),
